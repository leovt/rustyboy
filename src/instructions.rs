...
Instruction {mnemo: "SUB B", length: 1u8, cycles: 4u8, operation:DATA8 {op: SUB, dst: A, src: B, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SUB C", length: 1u8, cycles: 4u8, operation:DATA8 {op: SUB, dst: A, src: C, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SUB D", length: 1u8, cycles: 4u8, operation:DATA8 {op: SUB, dst: A, src: D, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SUB E", length: 1u8, cycles: 4u8, operation:DATA8 {op: SUB, dst: A, src: E, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SUB H", length: 1u8, cycles: 4u8, operation:DATA8 {op: SUB, dst: A, src: H, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SUB L", length: 1u8, cycles: 4u8, operation:DATA8 {op: SUB, dst: A, src: L, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
...
Instruction {mnemo: "SUB A", length: 1u8, cycles: 4u8, operation:DATA8 {op: SUB, dst: A, src: A, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
...
Instruction {mnemo: "AND B", length: 1u8, cycles: 4u8, operation:DATA8 {op: AND, dst: A, src: B, z: CalculateFlag, n: ResetFlag, h: SetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "AND C", length: 1u8, cycles: 4u8, operation:DATA8 {op: AND, dst: A, src: C, z: CalculateFlag, n: ResetFlag, h: SetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "AND D", length: 1u8, cycles: 4u8, operation:DATA8 {op: AND, dst: A, src: D, z: CalculateFlag, n: ResetFlag, h: SetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "AND E", length: 1u8, cycles: 4u8, operation:DATA8 {op: AND, dst: A, src: E, z: CalculateFlag, n: ResetFlag, h: SetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "AND H", length: 1u8, cycles: 4u8, operation:DATA8 {op: AND, dst: A, src: H, z: CalculateFlag, n: ResetFlag, h: SetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "AND L", length: 1u8, cycles: 4u8, operation:DATA8 {op: AND, dst: A, src: L, z: CalculateFlag, n: ResetFlag, h: SetFlag, c: ResetFlag, bit: 0u8}},
...
Instruction {mnemo: "AND A", length: 1u8, cycles: 4u8, operation:DATA8 {op: AND, dst: A, src: A, z: CalculateFlag, n: ResetFlag, h: SetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "XOR B", length: 1u8, cycles: 4u8, operation:DATA8 {op: XOR, dst: A, src: B, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "XOR C", length: 1u8, cycles: 4u8, operation:DATA8 {op: XOR, dst: A, src: C, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "XOR D", length: 1u8, cycles: 4u8, operation:DATA8 {op: XOR, dst: A, src: D, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "XOR E", length: 1u8, cycles: 4u8, operation:DATA8 {op: XOR, dst: A, src: E, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "XOR H", length: 1u8, cycles: 4u8, operation:DATA8 {op: XOR, dst: A, src: H, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "XOR L", length: 1u8, cycles: 4u8, operation:DATA8 {op: XOR, dst: A, src: L, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
...
Instruction {mnemo: "XOR A", length: 1u8, cycles: 4u8, operation:DATA8 {op: XOR, dst: A, src: A, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "OR B", length: 1u8, cycles: 4u8, operation:DATA8 {op: OR, dst: A, src: B, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "OR C", length: 1u8, cycles: 4u8, operation:DATA8 {op: OR, dst: A, src: C, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "OR D", length: 1u8, cycles: 4u8, operation:DATA8 {op: OR, dst: A, src: D, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "OR E", length: 1u8, cycles: 4u8, operation:DATA8 {op: OR, dst: A, src: E, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "OR H", length: 1u8, cycles: 4u8, operation:DATA8 {op: OR, dst: A, src: H, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "OR L", length: 1u8, cycles: 4u8, operation:DATA8 {op: OR, dst: A, src: L, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
...
Instruction {mnemo: "OR A", length: 1u8, cycles: 4u8, operation:DATA8 {op: OR, dst: A, src: A, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: ResetFlag, bit: 0u8}},
Instruction {mnemo: "CP B", length: 1u8, cycles: 4u8, operation:DATA8 {op: CP, dst: A_RO, src: B, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "CP C", length: 1u8, cycles: 4u8, operation:DATA8 {op: CP, dst: A_RO, src: C, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "CP D", length: 1u8, cycles: 4u8, operation:DATA8 {op: CP, dst: A_RO, src: D, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "CP E", length: 1u8, cycles: 4u8, operation:DATA8 {op: CP, dst: A_RO, src: E, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "CP H", length: 1u8, cycles: 4u8, operation:DATA8 {op: CP, dst: A_RO, src: H, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "CP L", length: 1u8, cycles: 4u8, operation:DATA8 {op: CP, dst: A_RO, src: L, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "CP (HL)", length: 1u8, cycles: 8u8, operation:DATA8 {op: CP, dst: A_RO, src: ADDR_HL, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "CP A", length: 1u8, cycles: 4u8, operation:DATA8 {op: CP, dst: A_RO, src: A, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
...
Instruction {mnemo: "LDH (a8),A", length: 2u8, cycles: 12u8, operation:DATA8 {op: LD, dst: ADDR_IMM8, src: A, z: Unaffected, n: Unaffected, h: Unaffected, c: Unaffected, bit: 0u8}},
...
Instruction {mnemo: "ADD SP,r8", length: 2u8, cycles: 16u8, operation:SPIMM8 {dst: SP, }},
...
Instruction {mnemo: "LDH A,(a8)", length: 2u8, cycles: 12u8, operation:DATA8 {op: LD, dst: A, src: ADDR_IMM8, z: Unaffected, n: Unaffected, h: Unaffected, c: Unaffected, bit: 0u8}},
Instruction {mnemo: "POP AF", length: 1u8, cycles: 12u8, operation:DATA16 {op: LD, dst: AF, src: ADDR_SP_INC, z: Unaffected, n: Unaffected, h: Unaffected, c: Unaffected, }},
...
Instruction {mnemo: "LD HL,SP+r8", length: 2u8, cycles: 12u8, operation:SPIMM8 {dst: HL, }},
...
Instruction {mnemo: "CP d8", length: 2u8, cycles: 8u8, operation:DATA8 {op: CP, dst: A_RO, src: IMM8, z: CalculateFlag, n: SetFlag, h: CalculateFlag, c: CalculateFlag, bit: 0u8}},
...
Instruction {mnemo: "SRA B", length: 2u8, cycles: 8u8, operation:DATA8 {op: SRA, dst: B, src: Empty, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SRA C", length: 2u8, cycles: 8u8, operation:DATA8 {op: SRA, dst: C, src: Empty, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SRA D", length: 2u8, cycles: 8u8, operation:DATA8 {op: SRA, dst: D, src: Empty, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SRA E", length: 2u8, cycles: 8u8, operation:DATA8 {op: SRA, dst: E, src: Empty, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SRA H", length: 2u8, cycles: 8u8, operation:DATA8 {op: SRA, dst: H, src: Empty, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SRA L", length: 2u8, cycles: 8u8, operation:DATA8 {op: SRA, dst: L, src: Empty, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SRA (HL)", length: 2u8, cycles: 16u8, operation:DATA8 {op: SRA, dst: ADDR_HL, src: Empty, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: CalculateFlag, bit: 0u8}},
Instruction {mnemo: "SRA A", length: 2u8, cycles: 8u8, operation:DATA8 {op: SRA, dst: A, src: Empty, z: CalculateFlag, n: ResetFlag, h: ResetFlag, c: CalculateFlag, bit: 0u8}},
